...
public class FixedDepositsController implements Initializable {
    ...
    public ObservableList<SavingsAccountsConnectDB> getIncomeList(){
        ...
        String query = "SELECT * FROM fixeddeposits";
        Statement st;
        ResultSet rs;
    ...
    private void insertRecord(){
        String query = "INSERT INTO fixeddeposits VALUES ("+txId.getText()+", '"+txBankName.getText()+"', "+txAccountNo.getText()+", "+txAmount.getText()+")";
        executeQuery(query);
        showIncomeList();
    }

    private void updateRecord(){
        String query = "UPDATE fixeddeposits SET bankName = '"+txBankName.getText()+"', accountNo = "+txAccountNo.getText()+", amount = "+txAmount.getText()+" WHERE id = "+txId.getText()+" ";
        executeQuery(query);
        showIncomeList();
    }

    private void deleteRecord(){
        String query = "DELETE from fixeddeposits WHERE id = " + txId.getText()+ " ";
        executeQuery(query);
        showIncomeList();
    }
